...
gulp.task("copy-assets", function() {
  var assets = {
    ...
    scss: ["./node_modules/metismenu/dist/metisMenu.css"]
  };
  ...
  var third_party_assets = {
    css_js: [
      ...
      },
      {
        ...
        assets: ["./node_modules/jquery-mask-plugin/dist/jquery.mask.min.js"]
      },
      {
        name: "chart-js",
      ...
      },
      {
        ...
        assets: ["./node_modules/jquery.scrollto/jquery.scrollTo.min.js"]
      },
      ...
      {
        name: "c3",
        assets: ["./node_modules/c3/c3.min.js", "./node_modules/c3/c3.min.css"]
      },
      ...
      },
      {
        name: "rwd-table",
        assets: [
          "./node_modules/RWD-Table-Patterns/dist/js/rwd-table.min.js",
      ...
      {
        name: "jquery-mockjax",
        assets: ["./node_modules/jquery-mockjax/dist/jquery.mockjax.min.js"]
      },
      {
        name: "autocomplete",
        assets: [
      ...
      {
        name: "autonumeric",
        assets: ["./node_modules/autonumeric/autoNumeric-min.js"]
      },
      {
        name: "summernote",
        assets: [
      ...
      {
        name: "mdi",
        assets: ["./node_modules/@mdi/font/css/materialdesignicons.min.css"]
      },
      {
        name: "animate",
    ...
    font: ["./node_modules/@mdi/font/css/materialdesignicons.min.css"]
  };
  ...
  gulp
    .src(folder.src + "data/**")
    .pipe(gulp.dest(folder.dist_assets + "/data"));
});
...
gulp.task("javascript", function() {
  ...
  var app_pages_assets = {
    js: [
      folder.src + "js/pages/products.init.js",
      folder.src + "js/pages/companies.init.js",
      folder.src + "js/pages/negotiation.init.js",
