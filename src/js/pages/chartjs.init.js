  ...
  (ChartJs.prototype.respChart = function(selector, type, data, options) {
    ...
    (ChartJs.prototype.initCharts = function() {
      ...
      if ($("#pie-chart-example").length > 0) {
        //pie chart
        var pieChart = {
          labels: ["IPhone", "Mac", "Scooter", "Book"],
          datasets: [
            {
              data: [300, 135, 48, 154],
              backgroundColor: ["#7e57c2", "#fa5c7c", "#4fc6e1", "#ebeff2"],
        ...
        charts.push(
          this.respChart($("#pie-chart-example"), "Pie", pieChart, pieOpts)
        );
      }
      ...
      if ($("#donut-chart-example").length > 0) {
        ...
        var donutChart = {
          ...
          datasets: [
            {
              data: [128, 78, 48],
              backgroundColor: ["#4fc6e1", "#7e57c2", "#ebeff2"],
              borderColor: "transparent",
              borderWidth: "3"
            }
          ]
      ...
      if ($("#polar-chart-example").length > 0) {
        ...
        charts.push(
          this.respChart($("#polar-chart-example"), "PolarArea", polarChart)
        );
      }
